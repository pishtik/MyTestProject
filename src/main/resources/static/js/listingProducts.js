		...
		if($(this).hasClass("active")) {
			...
			// and in the process of switching views!
  			...
  			if(theid == "gridview") {
				...
				iconx.addClass("addedGrid");
				grid.addClass("gridviewCl");
				
				$("br.description").hide();
				$("span.description").hide();
				$("span.description").prependTo("a.gridColumn");
				...
				//$("a.gridColumn").appendTo("section.left");
				//$( "a.gridColumn" ).remove();
				
				iconx.removeClass("addedGrid");
				grid.removeClass("gridviewCl");
			} 
		}
